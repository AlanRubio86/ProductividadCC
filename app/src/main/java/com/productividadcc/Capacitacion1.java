...
public class Capacitacion1 extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener {
    String imeiNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.capacitacion1_activity);
        ...
        events = (Spinner) findViewById(R.id.tipos);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Capacitacion1.this, MainActivity.class);
        ...
        //Log.d("Capacitacion1", getIntent().getExtras().getString("eventId"));
        ...
        //if(!getIntent().getExtras().getString("eventId").equalsIgnoreCase("")){
            ...
            //Log.d("Capacitacion1 IF", eventID);
        }else{
            eventID = "0";
            //Log.d("Capacitacion1 ELSE", eventID);
        }
        ...
        findViewById(R.id.fechaTxt).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog.newInstance(Capacitacion1.this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show(getFragmentManager(), "datePicker");
            }
        });
        ...
        findViewById(R.id.horaTxt).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimePickerDialog.newInstance(Capacitacion1.this, calendar.get(Calendar.HOUR), calendar.get(Calendar.MINUTE), true).show(getFragmentManager(), "timePicker");
            }
        });
        ...
        findViewById(R.id.guardarBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!montoTxt.getText().toString().equals("") && !integrantesTxt.getText().toString().equals("") && !fechaTxt.getText().toString().equals("")
                    ...
                    if (Utils.isNetworkAvailable(Capacitacion1.this)) {
                        sendEventInfo();
                    } else {
                        saveEventInfo();
                    }
        ...
        findViewById(R.id.reprogBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Capacitacion1.this, ReprogAgenda.class);
        ...
        findViewById(R.id.cerrarBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Capacitacion1.this, CancelaCap1.class);
                intent.putExtra("groupName", nombreLbl.getText());
                intent.putExtra("eventId", eventID);
                startActivity(intent);
                finish();
    ...
    public void sendEventInfo() {
        ...
        if (id == Globales.TIPO_NUEVO){
            tipoGrupo = "1";
        } else if( id == Globales.TIPO_ESTRELLA){
            tipoGrupo = "2";
        }  else if( id == Globales.TIPO_SUPEREST){
            tipoGrupo = "3";
        }

        URL +=  "fecha=" + selectedStringDate +
                "&hora=" + horaTxt.getText().toString() +
                "&tipEve=" + Globales.CAPACITACION_1 +
