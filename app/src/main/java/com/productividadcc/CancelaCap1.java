...
public class CancelaCap1 extends AppCompatActivity  {
    String imeiNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cancelacap1_activity);
        ...
        events = (Spinner) findViewById(R.id.motCap1);
        mTitle.setText("Cancelacion de Capacitacion 1");
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CancelaCap1.this, MainActivity.class);
    ...
    public void sendEventInfo() {
        ...
        if (id == Globales.MC_CAP1_NOREUNIERON){
            motivoCancelacion = Globales.STR_CAP1_NOREUNIERON;
        } else if( id == Globales.MC_CAP1_NOINTERESO){
            motivoCancelacion = Globales.STR_CAP1_NOINTERESO;
        }  else if( id == Globales.MC_CAP1_FALTAGENTE){
            motivoCancelacion = Globales.STR_CAP1_FALTAGENTE;
        }
