...
public class CancelaCap2 extends AppCompatActivity  {
    String imeiNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cancelacap2_activity);
        ...
        events = (Spinner) findViewById(R.id.motCap2);
        mTitle.setText("Cancelacion Capacitacion 2");
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CancelaCap2.this, MainActivity.class);
    ...
    public void sendEventInfo() {
        ...
        if (id == Globales.MC_CAP2_NOREUNIERON){
            motivoCancelacion = Globales.STR_CAP2_NOREUNIERON;
        } else if( id == Globales.MC_CAP2_FALTAPAPELE){
            motivoCancelacion = Globales.STR_CAP2_FALTAPAPELE;
        }
