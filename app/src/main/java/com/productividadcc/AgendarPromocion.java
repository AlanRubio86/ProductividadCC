...
public class AgendarPromocion extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener {
    String imeiNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agendar_promocion_activity);
        ...
        mTitle.setText("Agendar Promoción");
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgendarPromocion.this, AgregarEvento.class);
        ...
        findViewById(R.id.fechaTxt).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog.newInstance(AgendarPromocion.this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show(getFragmentManager(), "datePicker");
            }
        });
        ...
        findViewById(R.id.horaTxt).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimePickerDialog.newInstance(AgendarPromocion.this, calendar.get(Calendar.HOUR), calendar.get(Calendar.MINUTE), true).show(getFragmentManager(), "timePicker");
            }
        });
        ...
        findViewById(R.id.guardarBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!direccionTxt.getText().toString().equals("") && !fechaTxt.getText().toString().equals("")
                        && !horaTxt.getText().toString().equals("")) {
                    if (Utils.isNetworkAvailable(AgendarPromocion.this)) {
                        sendEventInfo();
                    } else {
                        saveEventInfo();
                    }
    ...
    public void sendEventInfo() {
        ...
        final String direccion = direccionTxt.getText().toString();
        final String newDireccion = direccion.replace(" ", "").trim();
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.GET, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent intent = new Intent(AgendarPromocion.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("integr", "0");
                params.put("semRen", "0");
                params.put("coment", newDireccion);
