...
public class Desembolso extends AppCompatActivity {
    ...
    String imeiNumber;
    EditText grupoTxt, montoTxt, integrantesTxt;
    String eventID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desembolso_activity);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Desembolso.this, AgregarEvento.class);
        ...
        grupoTxt = (EditText) findViewById(R.id.numeroTxt);
        ...
        findViewById(R.id.guardarBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!grupoTxt.getText().toString().equals("") && !montoTxt.getText().toString().equals("") && !integrantesTxt.getText().toString().equals("")) {
                    if (Utils.isNetworkAvailable(Desembolso.this)) {
                        sendEventInfo();
                    } else {
                        saveEventInfo();
                    }
        ...
        findViewById(R.id.reprogBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Desembolso.this, ReprogAgenda.class);
        ...
        findViewById(R.id.cerrarBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Desembolso.this, CancelaDesem.class);
                intent.putExtra("groupName", nombreLbl.getText());
                intent.putExtra("eventId", eventID);
                startActivity(intent);
                finish();
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.GET, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent intent = new Intent(Desembolso.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
