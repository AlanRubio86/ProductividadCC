...
public class CancelaDesem extends AppCompatActivity  {
    String imeiNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.canceladesem_activity);
        ...
        events = (Spinner) findViewById(R.id.motDese);
        mTitle.setText("Cancelacion Desembolso");
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CancelaDesem.this, MainActivity.class);
    ...
    public void sendEventInfo() {
        ...
        if (id == Globales.MC_DESE_CLIENTENOPRE){
            motivoCancelacion = Globales.STR_DESE_CLIENTENOPRE;
        } else if( id == Globales.MC_DESE_FALTAINE){
            motivoCancelacion = Globales.STR_DESE_FALTAINE;
        }  else if( id == Globales.MC_DESE_GERENTERECHAZA){
            motivoCancelacion = Globales.STR_DESE_GERENTERECHAZA;
        }
